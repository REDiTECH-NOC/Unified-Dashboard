...
export function OutboundNotificationsSection() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold">Outbound System Notifications</h3>
          <p className="text-sm text-muted-foreground mt-0.5">
            Configure email, Teams, and SMS delivery for system-level notification types.
          </p>
        </div>
        {notifications && (
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    emailEnabled ? "bg-emerald-500" : "bg-muted-foreground/30"
                  )}
                >
                  <span
                    className={cn(
            ...
            <div className="rounded-md border border-border p-4 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={cn(
                    "relative inline-flex h-5 w-9 items-center rounded-full transition-colors",
                    teamsEnabled ? "bg-emerald-500" : "bg-muted-foreground/30"
                  )}
                >
                  <span
                    className={cn(
                      "inline-block h-3.5 w-3.5 rounded-full bg-white transition-transform",
                      teamsEnabled ? "translate-x-[18px]" : "translate-x-0.5"
                    )}
                  />
                </button>
              </div>
